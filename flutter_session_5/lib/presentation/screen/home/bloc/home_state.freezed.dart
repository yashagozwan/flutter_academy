...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Status status, List<GameModel> games, String message});
}
...
class _$HomeStateImpl implements _HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(status: $status, games: $games, message: $message)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, status,
      const DeepCollectionEquality().hash(_games), message);
